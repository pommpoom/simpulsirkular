      ...
      <nav className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <div className="flex items-center justify-between gap-4">
          <Link href="/" className="inline-flex items-center gap-3">
            <div className="pulse-ring flex h-11 w-11 items-center justify-center rounded-2xl bg-[var(--brand)] text-white shadow-lg shadow-emerald-900/10">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <Link
            href="/lapor"
            className="button-glow hidden items-center gap-2 rounded-full bg-[var(--brand)] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[var(--brand-deep)] lg:inline-flex"
          >
            <Recycle className="h-4 w-4" />
            Setor Limbah
          </Link>
