          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3 text-sm font-semibold text-[var(--muted)]">
                <span className="rounded-full bg-white/80 px-4 py-2">Pickup lebih terarah</span>
                <span className="rounded-full bg-white/80 px-4 py-2">Input lebih singkat</span>
                <span className="rounded-full bg-white/80 px-4 py-2">Cocok untuk mobile</span>
              </div>
            </div>
          ...
          <div className="rounded-[32px] border border-white/70 bg-white/75 p-6 shadow-[var(--shadow)] backdrop-blur md:p-8">
            ...
            <div className="mt-6 space-y-4">
              {steps.map((step, index) => (
                <article key={step.title} className="rounded-3xl border border-[var(--line)] bg-[var(--surface-strong)] p-5">
